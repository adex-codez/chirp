...
Infer the repo from `git remote -v`; `gh` does this automatically when run inside a clone. This repository must have its GitHub remote configured before these operations can run.
